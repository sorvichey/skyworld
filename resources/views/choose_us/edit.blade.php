    ...
    <div class="card card-gray">
        ...
        <div class="card-block">
            <div class="col-md-9">
                ...
                @endif
                <form action="{{url('admin/choose_us/update')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" value="{{$choose_us->id}}" name="id">
                    <div class="form-group row">
                        <label for="description" class="col-sm-4 form-control-label">Name<span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" step="1" name='description' id="description" class='form-control' value="{{$choose_us->description}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div style="margin-top: 3px">
                                <img src="{{asset($choose_us->featured_image)}}" alt="" width="60" id="preview">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
