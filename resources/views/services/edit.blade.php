                ...
                <form action="{{url('admin/service/update')}}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div style="margin-top: 3px">
                                <img src="{{URL::asset($service->icon)}}" alt="" width="100"  id="preview">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" step="1" name='order' id="order" class='form-control' value="{{$service->order}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="short_description" id="short_description" cols="30" rows="10">{{$service->short_description}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="description" id="description" cols="30" rows="10" class="ckeditor">{{$service->description}}</textarea>
                        </div>
                    </div>
