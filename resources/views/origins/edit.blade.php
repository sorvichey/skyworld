    ...
    <div class="card card-gray">
        <div class="card-header">
            <div class="header-block">
                <p class="title">Edit Origin
                    <a href="{{url('admin/origin')}}" class="btn btn-primary-outline btn-oval btn-sm mx-left"> 
        ...
        <div class="card-block">
            <div class="col-md-9">
                ...
                @endif
                <form action="{{url('admin/origin/update')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" value="{{$origin->id}}" name="id">
                    <div class="form-group row">
                        <label for="name" class="col-sm-4 form-control-label">Name</label>
                        <div class="col-sm-8">
                            <input type="text" step="1" name='name' id="name" class='form-control' value="{{$origin->name}}">
                        </div>
                    </div>
                    <div class="form-group row">
