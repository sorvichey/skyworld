    ...
    <div class="card card-gray">
        <div class="card-header">
            <div class="header-block">
                <p class="title">Edit Destination
        ...
        <div class="card-block">
            <div class="col-md-9">
                ...
                @endif
                <form action="{{url('admin/destination/update')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" value="{{$destination->id}}" name="id">
                    <div class="form-group row">
                        <label for="name" class="col-sm-4 form-control-label">Name</label>
                        <div class="col-sm-8">
                            <input type="text" step="1" name='name' id="name" class='form-control' value="{{$destination->name}}">
                        </div>
                    </div>
                    <div class="form-group row">
