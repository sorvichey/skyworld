    ...
    <div class="card card-gray">
        ...
        <div class="card-block">
            <div class="col-md-9">
                ...
                @endif
                <form action="{{url('admin/industry/save')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-group row">
                        <label for="title" class="col-sm-4 form-control-label">Title<span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" step="1" name='title' id="title" class='form-control' value="{{old('title')}}">
                        </div>
                    </div>
                    <div class="form-group row">
