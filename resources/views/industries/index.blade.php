        ...
        <div class="card-header">
            <div class="col-sm-4">
                <div class="header-block">
                    <p class="title"> Industry <a href="{{url('admin/industry/create')}}" class="btn btn-primary-outline btn-oval btn-sm mx-left"> 
                        ...
                        <tbody>
                            ...
                            @foreach($industries as $s)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{url('admin/industry/edit/'.$s->id)}}" title="កែប្រែ" class="text-success">
                                            <i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                        <a href="{{url('admin/industry/delete/'.$s->id)}}" title="លុប" 
