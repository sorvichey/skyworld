    ...
    <div class="card card-gray">
        ...
        <div class="card-block">
            <div class="col-md-9">
                ...
                @endif
                <form action="{{url('admin/tracking/update')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" value="{{$tracking->id}}" name="id">
                    <div class="form-group row">
                        <label for="waybill" class="col-sm-4 form-control-label">Bill Way<span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" name='waybill' id="waybill" class='form-control' value="{{$tracking->waybill}}" autofocus required>
                        </div>
                    </div>
                    <div class="form-group row form-control-label">
                        ...
                        <div class="col-sm-8">
                            <select name="destination" id="destination" class="form-control chosen-select" required>
                                ...
                                <option value="{{$destination->id}}" {{$destination->id==$tracking->destination?'selected':''}}>{{$destination->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row form-control-label">
                        ...
                        <div class="col-sm-8">
                            <select name="origin" id="origin" class="form-control chosen-select" required>
                                ...
                                <option value="{{$origin->id}}" {{$origin->id==$tracking->origin?'selected':''}}>{{$origin->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row form-control-label">
                        ...
                        <div class="col-sm-8">
                            <select name="status" id="status" class="form-control chosen-select" required>
                                ...
                                <option value="{{$status->id}}" {{$status->id==$tracking->status?'selected':''}}>{{$status->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name='pcs' id="pcs" class='form-control' value="{{$tracking->pcs}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="dameetie" class="col-sm-4 form-control-label">Date Time<span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="date" name='datetime' id="datetime" class='form-control' value="{{$tracking->datetime}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="time" class="col-sm-4 form-control-label">Time<span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" name='time' id="time" class='form-control' value="{{$tracking->time}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="receiver" class="col-sm-4 form-control-label">Receiver<span class="text-danger">*</span></label>
                        <div class="col-sm-8">
                            <input type="text" name='receiver' id="receiver" class='form-control' value="{{$tracking->receiver}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
