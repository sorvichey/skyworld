    ...
    <div class="card card-gray">
        ...
        <div class="card-block">
            <div class="col-md-9">
                ...
                @endif
                <form action="{{url('admin/location-slide/save')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" value="{{$location->id}}" name="id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="file" class="form-control" required name="photo" accept="image/x-png,image/gif,image/jpeg" onchange="loadFile(event)">
                            <div style="margin-top: 3px">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" step="1" min="1" value="1" class="form-control" id="order" name="order" value="{{old('order')}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="Name" class="col-sm-4 form-control-label">&nbsp;</label>
