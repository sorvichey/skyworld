...
@section('content')
    ...
    <div class="card card-gray">
        <div class="card-header">
            <div class="header-block">
                <p class="title">កែប្រែ ការបរិយាយបន្តែមក្នុងទំព័រ<a href="{{url('admin/page/edit/'.$page->id)}}" class="btn btn-primary-outline btn-oval btn-sm mx-left"> 
        ...
        <div class="card-block">
            <div class="col-md-9">
                ...
                @endif
                <form action="{{url('admin/sub-page/update')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="order" value="{{$sub_page->order}}" name="order">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div style="margin-top: 3px">
                                <img src="{{URL::asset($sub_page->featured_image)}}" alt="" width="100"  id="preview">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="youtube" value="{{$sub_page->youtube}}" name="youtube">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name="sub_description" id="sub_description" cols="30" rows="10" class="ckeditor">{{$sub_page->description}}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="Name" class="col-sm-4 form-control-label">&nbsp;</label>
            ...
            <div class="card-block">
                ...
                <?php $sub_pages = DB::table('sub_pages')->orderBy('id', 'desc')->where('active', 1)->where('page_id', $page->id)->paginate(18);?>
