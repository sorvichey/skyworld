        ...
        <div class="card-header">
            <div class="col-sm-4">
                <div class="header-block">
                    <p class="title"> Status <a href="{{url('admin/status/create')}}" class="btn btn-primary-outline btn-oval btn-sm mx-left"> 
                        ...
                        <tbody>
                            ...
                            @foreach($statuss as $s)
                                <tr class="odd gradeX">
                                    ...
                                    <td>{{$s->name}}</td>
                                    <td>
                                        <a href="{{url('admin/status/edit/'.$s->id)}}" title="កែប្រែ" class="text-success">
                                            <i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                        <a href="{{url('admin/status/delete/'.$s->id)}}" title="លុប" 
